...
3. Draft a Technical Specification in Russian or English.
...
The v2.1 runner reads `task.yaml` directly:
...
- `codex`: implemented
- `claude-code`: planned, not implemented in v2.1
- `local`: planned, not implemented in v2.1
